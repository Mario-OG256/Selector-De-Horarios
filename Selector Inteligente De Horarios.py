...
class SelectorHorario(QWidget):
    ...
    def load_available_times(self):
        ...
        En una versión avanzada, podría consultar una base de datos para verificar disponibilidad real.

        Errores Potenciales:
        -------------------
        - Si el listado de horarios no carga, verificar conexión con fuente de datos (si aplica).
        """
    ...
    def confirm_selection(self):
        ...
        Errores Potenciales:
        -------------------
        - Si el usuario no selecciona horario, podría implementarse una validación adicional para mostrar advertencia.
        """
